      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            _featureCard(Icons.eco, 'Crop Health Tips'),
            _featureCard(Icons.cloud, 'Weather Forecast'),
            _featureCard(Icons.shopping_cart, 'Market Rates'),
            _featureCard(Icons.support, 'Farmer Support'),
            const SizedBox(height: 30),
          ],
        ),
      ),
